...
class AppController(QObject):
    ...
    def __init__(self, window: QMainWindow):
        ...
        # Connect status/error signals from tab controllers to the main window
    ...
    def _open_image_for_active_tab(self):
        ...
        QMessageBox.information(
            self.window,
            "Information",
            "Please use the 'Load Image 1' or 'Load Image 2' buttons on the Matching Images tab.",
        )
    ...
    def _about(self):
        ...
        QMessageBox.about(
            ...
            "A project demonstrating SIFT feature detection and matching.<br>"
